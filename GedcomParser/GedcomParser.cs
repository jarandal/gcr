...
namespace GedcomParser
{
	...
	public class GedcomParser
	{
        ...
        private string _OriginalRefID = string.Empty;
        ...
        /// <value>
        /// Value of the id previous to be replaced
        /// </value>
        public string OriginalRefID
        {
            get { return _OriginalRefID; }
        }
					...
					case GedcomState.XrefID:
						...
						if (IsXrefID(data,temp))
						{
							...
							else
							{
                                ...
                                Gedcom.XRefIndexedKeyCollection aux = (Gedcom.XRefIndexedKeyCollection)_xrefCollection;
                                _OriginalRefID = aux.GetOriginalReferenceID(_XrefID);
